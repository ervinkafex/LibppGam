...
% oooooooooOOOOOOOOOOOOooooooooooooOOOOOOOOOOOOOOoooooooooooooooo
% oooooooooOOOOOOOOOOOOooooooooooooOOOOOOOOOOOOOOoooooooooooooooo
% From QGSJET multiplicity Tp > 2 GeV

i3pi = Tp>2;

XS5toHigh(i3pi) = Geant4QGSJETPi0Multiplicity(Tp(i3pi)).*XSinel(Tp(i3pi));
