...
% 
% For Tp>2 GeV up to 100 TeV the cross section is taken from 
% Geant4 pi0 production multiplicity
...
% oooooooooOOOOOOOOOOOOooooooooooooOOOOOOOOOOOOOOoooooooooooooooo
% oooooooooOOOOOOOOOOOOooooooooooooOOOOOOOOOOOOOOoooooooooooooooo
% From Geant4 multiplicity Tp >= 2 GeV

i3pi = Tp>2;

XS5toHigh(i3pi) = Geant4Pi0Multiplicity(Tp(i3pi)).*XSinel(Tp(i3pi));
