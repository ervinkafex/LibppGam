...
% 
% From 2 GeV < Tp <= 100 GeV the cross section is taken from 
% Geant4 pi0 production multiplicity. For Tp > 100 GeV we take
% from SIBYLL multiplicity.
...
% oooooooooOOOOOOOOOOOOooooooooooooOOOOOOOOOOOOOOoooooooooooooooo
% oooooooooOOOOOOOOOOOOooooooooooooOOOOOOOOOOOOOOoooooooooooooooo
% From SIBYLL multiplicity Tp > 2 GeV

i3pi = Tp>2;

XS5toHigh(i3pi) = Geant4SIBYLLPi0Multiplicity(Tp(i3pi)).*XSinel(Tp(i3pi));
